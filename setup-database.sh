...
# Setup script for Postero with PostgREST
# This script sets up the entire PostgREST infrastructure

set -e  # Exit on any error

echo "🚀 Setting up Postero with PostgREST"
echo "======================================"
...
echo ""
echo "📖 Next steps:"
echo "   1. Configure your Zotero API key in postero.toml"
echo "   2. Run your first sync: go run cmd/sync/*.go -c postero.toml"
